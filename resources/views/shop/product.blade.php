			...
			<div class="row">
				<div class="col-lg-6">
					<div class="product-pic-zoom">
						<img class="product-big-img" src="{{ asset('storage/' . $groupproduct->image) }}" alt="">
					</div>
					<div class="product-thumbs" tabindex="1" style="overflow: hidden; outline: none;">
						<div class="product-thumbs-track">
							<div class="pt active" data-imgbigurl="img/single-product/1.jpg"><img src="{{ asset('storage/' . $groupproduct->image) }}" alt=""></div>
				...
				<div class="col-lg-6 product-details">
					<h2 class="p-title">{{ $groupproduct->name }}</h2>
					<h3 class="p-price">{{ $groupproduct->price }} руб.</h3>
