        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link :to="{ name: 'adminproducts'}">Товары</router-link>
              </li>
              <li class="nav-item">
                <router-link :to="{ name: 'adminorders'}"><i class="fa fa-circle-o nav-icon"></i><p>Заказы</p></router-link>
              </li>
              <li class="nav-item">
                <router-link :to="{ name: 'adminpurchases'}"><i class="fa fa-circle-o nav-icon"></i><p>Контракты</p></router-link>
              </li>
            </ul>
          </li>
          <li class="nav-item">
